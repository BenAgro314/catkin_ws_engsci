...
namespace global_planner
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(GlobalPlannerNodeConfig &config, const GlobalPlannerNodeConfig &max, const GlobalPlannerNodeConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const GlobalPlannerNodeConfig &config1, const GlobalPlannerNodeConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, GlobalPlannerNodeConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const GlobalPlannerNodeConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, GlobalPlannerNodeConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const GlobalPlannerNodeConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const GlobalPlannerNodeConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, GlobalPlannerNodeConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(GlobalPlannerNodeConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerNodeConfig::ParamDescription<std::string>("default_node_type_", "str", 4, "Change search mode", "{'enum': [{'name': 'Node', 'type': 'str', 'value': 'Node', 'srcline': 44, 'srcfile': '/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'Normal node', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'NodeWithoutSmooth', 'type': 'str', 'value': 'NodeWithoutSmooth', 'srcline': 45, 'srcfile': '/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'No smooth cost', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'SpeedNode', 'type': 'str', 'value': 'SpeedNode', 'srcline': 46, 'srcfile': '/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'Search with speed', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Change search mode'}", &GlobalPlannerNodeConfig::default_node_type_)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(GlobalPlannerNodeConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerNodeConfig::ParamDescription<std::string>("default_node_type_", "str", 4, "Change search mode", "{'enum': [{'name': 'Node', 'type': 'str', 'value': 'Node', 'srcline': 44, 'srcfile': '/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'Normal node', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'NodeWithoutSmooth', 'type': 'str', 'value': 'NodeWithoutSmooth', 'srcline': 45, 'srcfile': '/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'No smooth cost', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'SpeedNode', 'type': 'str', 'value': 'SpeedNode', 'srcline': 46, 'srcfile': '/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg', 'description': 'Search with speed', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Change search mode'}", &GlobalPlannerNodeConfig::default_node_type_)));
...
//#line 44 "/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
      const char * const GlobalPlannerNode_Node = "Node";
//#line 45 "/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
      const char * const GlobalPlannerNode_NodeWithoutSmooth = "NodeWithoutSmooth";
//#line 46 "/home/agrobenj/catkin_ws/src/avoidance/global_planner/cfg/GlobalPlannerNode.cfg"
